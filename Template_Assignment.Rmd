...
In 3.6 where we analysed the event of our choosing, the 2008 financial crisis, it has become clear that after this event the unemployment skyrocketed. This makes sense with that we already know about this time period and the consequences from the financial crisis. It also makes sense from an economic view. Due to the crisis, consumers started consuming way less and businesses held back on their investments. Therefore the aggregated demand dropped massively, plummeting the GDP. According to Okun's law, for each reduction in GDP from its potential, the unemployment rate goes up. The reason why the unemployment rate kept rising after the initial crisis is because unemployment is a lagging economic indicator, meaning it changes after an event has taken place. In a crisis, businesses don't immediately fire everyone. They first cut back on working hours and wages, in the hope that the crisis will be averted soon. As the crisis worsens, mass layoffs begin. Therefore the unemployment rate continues to increase even after the GDP begins to climb up again.
